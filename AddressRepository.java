...
public class AddressRepository implements AddressDetailsRepositoryInterface {
	...
	private static final String SELECT_ALL_ADDRESSES ="select * from address_details";
	@Autowired
	...
	public List<Address> getAllAddresses() {
		List<Address> allAddresses = jdbcTemplate.query(SELECT_ALL_ADDRESSES, new AddressRowMapper());
		return allAddresses;
	}
